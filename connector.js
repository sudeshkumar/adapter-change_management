...
class ServiceNowConnector {
   ...
   * @memberof ServiceNowConnector
   * @method constructUri
   * @summary Construct GET or POST URL of ServiceNow
   ...
   * @summary To check the ServiceNow developer instance is Hibernated
   ...
   * @summary Process the ServiceNow response result
   ...
   * @memberof ServiceNowConnector
   * @method sendRequest
   * @summary Send the GET/POST request of ServiceNow API
